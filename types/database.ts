  ...
  public: {
    Tables: {
      ...
      automation_settings: {
        Row: {
          id: string;
          provider: "facebook" | "automation_engine";
          ...
          last_automation_run_at: Timestamp | null;
          last_successful_post_at: Timestamp | null;
          pause_reason: string | null;
          auto_post_enabled: boolean;
          auto_dm_enabled: boolean;
          auto_reply_enabled: boolean;
          preferred_platforms: Json;
          preferred_schedule_times: Json;
      ...
      auto_posts: {
        Row: {
          ...
          title: string;
          content: string;
          content_type: "educational" | "sales" | "video_script";
          platform: "instagram" | "facebook" | "tiktok" | "x" | "multi-platform";
          status: "draft" | "scheduled" | "posted" | "simulated";
